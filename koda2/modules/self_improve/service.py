...
class SelfImproveService:
    ...
    def __init__(self) -> None:
        self._known_capabilities: dict[str, str] = {
            ...
            "send_email": "email",
            "read_email": "email",
            "send_email_with_attachments": "email",
            "download_email_attachment": "email",
            ...
            "get_proactive_alerts": "proactive",
            "start_proactive_monitoring": "proactive",
            "stop_proactive_monitoring": "proactive",
        }
