...
class Settings(BaseSettings):
    ...
    # ── General ──────────────────────────────────────────────────────
    executiveai_env: str = "development"
    executiveai_log_level: str = "INFO"
    executiveai_secret_key: str = "change-me"
    executiveai_encryption_key: str = ""
    ...
    # ── Database ─────────────────────────────────────────────────────
    database_url: str = "sqlite+aiosqlite:///data/executiveai.db"
